...
assert.equal(`O tempo de preparo deve ser um valor entre 1 e ${max-1}`, calculator.minimumTime("a", 15, 22));
assert.equal(`O tempo das ampulhetas deve ser um valor entre 1 e ${max-1}`, calculator.minimumTime(14, "cvb", 22));
assert.equal(`O tempo das ampulhetas deve ser um valor entre 1 e ${max-1}`, calculator.minimumTime(14, 15, "ss"));
assert.equal(`O tempo de preparo deve ser um valor entre 1 e ${max-1}`, calculator.minimumTime("d", "aa", "ss"));
